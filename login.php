...
<html lang="en">
  ...
  ?>
    ...
    ?>
        <img class="mb-4" src="assets/images/lg.png" alt="" width="260" height="150">
        <h1 class="h4 mb-3 font-weight-normal" >Event Decission Making</h1>
        ...
        <p class="mt-4 mb-3 text-muted">Sistem Pendukung Keputusan</p>  
      </form>
  <?php
  }
  ?>
