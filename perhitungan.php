...
<tbody> <tr>
                  ...
                  <?php
                    ...
                    $value4 =cari_nilai("select target as nilai from pm_faktor where id_faktor=5");
                    $value4 =cari_nilai("select target as nilai from pm_faktor where id_faktor=6");
                    $value4 =cari_nilai("select target as nilai from pm_faktor where id_faktor=7");
