				...
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<select name="id_aspek" id="id_aspek" class="form-control" required="true">
							<option value="1" <?php if ($id_aspek == "1"){ echo "selected"; } ?>>Berkas</option>
							<option value="2" <?php if ($id_aspek == "2"){ echo "selected"; } ?>>Panitia</option>
							<option value="3" <?php if ($id_aspek == "3"){ echo "selected"; } ?>>Peserta</option>
						</select>
					</div>
					<div class="form-group">
						<label>faktor</label>
					...
					<div class="form-group">
						...
						<select name="target" id="target" class="form-control" required="true">
							...
							<option value="5" <?php if ($target == "3"){ echo "selected"; } ?>>5</option>
							<option value="6" <?php if ($target == "3"){ echo "selected"; } ?>>6</option>
							<option value="7" <?php if ($target == "3"){ echo "selected"; } ?>>7</option>
						</select>
					</div>
					<div class="form-group">
						<label>Type</label>
