      ...
      <div class="card-header">
         <div class="col-6">
            <select class="custom-select d-block w-50" id="aspek" name="aspek" required>
              ...
              <option value="kecerdasan" <?php echo $_REQUEST['aspek'] == "kecerdasan" ? "selected=selected" : "";?>>Berkas</option>
              <option value="wawancara" <?php echo $_REQUEST['aspek'] == "wawancara" ? "selected=selected" : "";?>>Panitia</option>
              <option value="sikapkerja" <?php echo $_REQUEST['aspek'] == "sikapkerja" ? "selected=selected" : "";?>>Peserta</option>
            </select>
         </div>
      </div>
      <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A1">
                        ...
                        <option value="5"  <?php echo $row['A1'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6"  <?php echo $row['A1'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7"  <?php echo $row['A1'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>

                    </td>
                    <td>
                       <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A2">
                        <option value="1" <?php echo $row['A2'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A2'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A2'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A2'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A2'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A2'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A2'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                    <td>
                        <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A3">
                        <option value="1" <?php echo $row['A3'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A3'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A3'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A3'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A3'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A3'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A3'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                    <td>
                        <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A4">
                        <option value="1" <?php echo $row['A4'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A4'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A4'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A4'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A4'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A4'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A4'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                  </tr>
                  <?php
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <option value="1" <?php echo $row['A5'] == 1 ? "selected=selected" : "";?>>1</option>
                        ...
                        <option value="5" <?php echo $row['A5'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A5'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A5'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>

                    </td>
                    <td>
                       <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A6">
                       <option value="1" <?php echo $row['A6'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A6'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A6'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A6'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A6'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A6'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A6'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                    <td>
                        <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A7">
                        <option value="1" <?php echo $row['A7'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A7'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A7'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A7'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A7'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A7'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A7'] == 7 ? "selected=selected" : "";?>>7</option>                      </select>
                    </td>
                    <td>
                        <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A8">
                        <option value="1" <?php echo $row['A8'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A8'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A8'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A8'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A8'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A8'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A8'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                  </tr>
                  <?php
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <option value="1" <?php echo $row['A9'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A9'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A9'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A9'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A9'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A9'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A9'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>

                    </td>
                    <td>
                       <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A10">
                       <option value="1" <?php echo $row['A10'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A10'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A10'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A10'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A10'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A10'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A10'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                    <td>
                        <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A11">
                        <option value="1" <?php echo $row['A11'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A11'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A11'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A11'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A11'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A11'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A11'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                    <td>
                        <select class="custom-select d-block w-100" name="<?php echo $row['id_pelamar']?>_A12">
                        <option value="1" <?php echo $row['A12'] == 1 ? "selected=selected" : "";?>>1</option>
                        <option value="2" <?php echo $row['A12'] == 2 ? "selected=selected" : "";?>>2</option>
                        <option value="3" <?php echo $row['A12'] == 3 ? "selected=selected" : "";?>>3</option>
                        <option value="4" <?php echo $row['A12'] == 4 ? "selected=selected" : "";?>>4</option>
                        <option value="5" <?php echo $row['A12'] == 5 ? "selected=selected" : "";?>>5</option>
                        <option value="6" <?php echo $row['A12'] == 6 ? "selected=selected" : "";?>>6</option>
                        <option value="7" <?php echo $row['A12'] == 7 ? "selected=selected" : "";?>>7</option>
                      </select>
                    </td>
                  </tr>
                  <?php
